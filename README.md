...
- Claude Code marketplace metadata in [`.claude-plugin/marketplace.json`](<HOME>
- Codex marketplace metadata in [`.agents/plugins/marketplace.json`](<HOME>
...
Codex reads the repo marketplace from [`.agents/plugins/marketplace.json`](<HOME>
