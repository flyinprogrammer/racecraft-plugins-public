...
`Base directory for this skill: <HOME>/.claude/plugins/cache/racecraft-public-plugins/speckit-pro/1.1.0/skills/speckit-autopilot`

Then:
```text
SKILL_SCRIPTS="<HOME>/.claude/plugins/cache/racecraft-public-plugins/speckit-pro/1.1.0/skills/speckit-autopilot/scripts"
```
